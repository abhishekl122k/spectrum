          ...
          <Grid.Row verticalAlign='middle'>
            ...
            <Grid.Column>
              <Header icon inverted>
                ...
                <Map/><br/>
              <p style={{ fontFamily: 'lucida console', color: 'gray'}}>A portal for excellence in news, completely token driven. This place could be considered a stock market for news, where average people and large news organizations make efforts to verify the news for which they get paid. </p>
